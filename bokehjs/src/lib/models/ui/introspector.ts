...
import introspector_css from "styles/introspector.css"
...
export class IntrospectorView extends HTMLBoxView {
  override model: Introspector

  private root_el: HTMLElement //ShadowRoot

  override initialize(): void {
    super.initialize()
    this.root_el = this.el //.attachShadow({mode: "open"})
    //diagnostics.connect(this)
  }

  /*
  override remove(): void {
    diagnostics.disconnect(this)
    super.remove()
  }

  protected on_property_changed(prop: p.Property): void {
  }
  */
  ...
  override render(): void {
    ...
    const introspector_el = div({class: "introspector"}, models_panel_el, column_el)
    ...
    this.root_el.appendChild(introspector_el)
  ...
  override styles(): string[] {
    return [...super.styles(), introspector_css]
  }
}

export namespace Introspector {
...
export interface Introspector extends Introspector.Attrs {}

export class Introspector extends HTMLBox {
  override properties: Introspector.Props
  override __view_type__: IntrospectorView

  static override __module__ = "bokeh.models.ui"

  constructor(attrs?: Partial<Introspector.Attrs>) {
    super(attrs)
  }

  static {
    this.prototype.default_view = IntrospectorView

    this.define<Introspector.Props>(({}) => ({
    }))
  }
}
